...
public class Residencia extends ExtraHotelero{
    ...
    public Residencia(int habitaciones, boolean descuentoGremio, boolean campoDeportivo, boolean privado, double metrosCuadrados, String nombre, String direccion, String localidad, String gerente) {
