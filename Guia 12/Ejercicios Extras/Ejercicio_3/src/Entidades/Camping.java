...
public class Camping extends ExtraHotelero{
    ...
    private int maximoCarpas;
    private int banosDisponibles;
    private boolean restaurante;

    public Camping() {
    }

    public Camping(int maximoCarpas, int banosDisponibles, boolean restaurante, boolean privado, double metrosCuadrados, String nombre, String direccion, String localidad, String gerente) {
        super(privado, metrosCuadrados, nombre, direccion, localidad, gerente);
        this.maximoCarpas = maximoCarpas;
        this.banosDisponibles = banosDisponibles;
    ...
    public int getBanosDisponibles() {
        return banosDisponibles;
    }

    public void setBanosDisponibles(int banosDisponibles) {
        this.banosDisponibles = banosDisponibles;
    }
    ...
    public String toString() {
        ...
        return super.toString() + "\nMaximo de carpas: " + maximoCarpas + "\nBaños disponibles: " + banosDisponibles + "\nRestaurante: " + op;
    }
