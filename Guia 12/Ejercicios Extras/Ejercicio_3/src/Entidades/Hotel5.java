...
public class Hotel5 extends Hotel4 {
    ...
    public Hotel5(int salonesConferencia, int suites, int limosinas, String nombreRestaurante, int capacidadRestaurante, String gimnasio, int habitaciones, int camas, int pisos, String nombre, String direccion, String localidad, String gerente) {
        super(nombreRestaurante, capacidadRestaurante, gimnasio, habitaciones, camas, pisos, nombre, direccion, localidad, gerente);
