...
Nombre del Restaurante, Capacidad del Restaurante.*/
    ...
    public Hotel4(String nombreRestaurante, int capacidadRestaurante, String gimnasio, int habitaciones, int camas, int pisos, String nombre, String direccion, String localidad, String gerente) {
